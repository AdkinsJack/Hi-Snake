...
borders = [pygame.Rect(0, 0, 2, 600), pygame.Rect(0, 0, 800, 2), pygame.Rect(800, 0, 2, 600), pygame.Rect(0, 598, 800, 2)]
...
class Score:
    ...
    def __init__(self, high_score_file):
        ...
        try:
            ...
            print("No high score found, you start at 0")
        except ValueError:
...
apple = pygame.Rect(randint(2, 53) * 15, randint(2, 39) * 15, 15, 15)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_q:
                        ...
                        gameOverLoop = False
            pygame.display.flip()
    if snake.get_head().colliderect(apple):
        snake.add_part()
        apple = pygame.Rect(randint(10, 790), randint(10, 590), 15, 15)
